...
def SVM_getIntent(user_input):
    ...
    if len(focus_category) == 0:
        return 'Still does not understand this general question yet!, please add more dataset!'

    return df.loc[df['focus'].isin(focus_category)]['answer'].values[0]  
